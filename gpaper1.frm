...
Private Sub cmdPrint_Click()
    ...
    'Debug.Print "Printer height and width"
    ...
    For CopyCounter = 1 To NumOfCopies
            ' -- Horizonal Lines
            WideCount = 0
            For Counter = 0 To PrnMaxH Step LineH
                If WideCount < WideH Then
                ...
                End If
                Printer.Line (0, Counter)-(PrnMaxW, Counter), ColorToPrint
            Next
            ' -- Vertical Lines
            WideCount = 0
            For Counter = 0 To PrnMaxW Step LineH
                If WideCount < WideV Then
                    WideCount = WideCount + 1
                    Printer.DrawWidth = Thickness
                Else
                    WideCount = 0
                    Printer.DrawWidth = WideThickness
                End If
                Printer.Line (Counter, 0)-(Counter, PrnMaxH), ColorToPrint
            Next
            Printer.NewPage
    Next 'copies
